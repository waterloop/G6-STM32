...
uint32_t WARN_OFFSET = 0xFF; // remove later. we need to resolve how to import config.h
// without getting redefinition errors from the compiler
// rn i dont have time to fix it cuz im literally hitting biceps and mahesh
// showed up to my apartment with his laptop and made me patch this

// to mahesh; please note which files you had to copy to this branch
// Files I copied to this branch:
//1. config.h
//2. can_driver.h
//3. can_driver.c
