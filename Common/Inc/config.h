...
>>>>>>> bd43edd (Added IMU message to config)
// FRAME 2
...
const Data_Segment_t SENSORS_ERROR_CODE        = {SENSOR_BOARD_1, 8, 8};
//SECOND (IMU) FRAME
...
const Data_Segment_t SENSORS_ERROR_CODE        = {SENSOR_BOARD_2, 8, 8};
